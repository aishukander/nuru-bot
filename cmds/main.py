...
class Main(Cog_Extension):
  ...
  async def em1(self,ctx):
    ...
    embed.add_field(name="包含 說謊的味道", value="這是說謊的味道的圖片", inline=True)
    embed.add_field(name="字尾包含 我不做人啦", value="我不做人啦JOJO的圖片", inline=True)
    embed.add_field(name="包含 典明粥", value="典明粥的圖片", inline=True)
    embed.add_field(name="包含 阿帕茶", value="阿帕茶的圖片", inline=True)
    embed.add_field(name="字尾包含 喝", value="喝的圖片", inline=True)
    embed.add_field(name="包含 勃起", value="boki的圖片", inline=True)
    embed.add_field(name="字尾包含 救護車", value="jojo護車的圖片", inline=True)
    embed.add_field(name="字尾包含 沒用", value="沒用的圖片", inline=True)
    embed.add_field(name="包含 塞車", value="行人道很寬敞的圖片", inline=True)
