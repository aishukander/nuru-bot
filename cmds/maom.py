...
class Maom(Cog_Extension):    
  ...
  async def em2(self,ctx):
    ...
    embed.add_field(name="包含 德意志科技", value="德意志科技世界第一 的圖片", inline=True)
    embed.add_field(name="字尾包含 玩腿", value="玩腿 的圖片", inline=True)
    embed.add_field(name="字尾包含 nice", value="nice 的圖片", inline=True)
    embed.add_field(name="包含 你下一句話", value="你下一句話要說的是 的圖片", inline=True)
    embed.add_field(name="字尾包含 呦喜", value="呦喜呦喜 的圖片", inline=True)
    embed.add_field(name="包含 成為超棒的單親媽媽", value="成為單親媽媽 的圖片", inline=True)
